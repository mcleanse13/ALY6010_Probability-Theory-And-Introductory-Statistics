ALY 6010: Probability and Statistics for Business Analytics

This course introduces fundamental statistical concepts and methods used in business analytics from an applied, data-driven perspective. Topics include frequency distributions, measures of central tendency and dispersion, probability, sampling, regression, correlation, and analysis of variance (ANOVA). I also gained a hands-on experience using statistical software such as R and Excel to conduct data analysis, perform hypothesis testing, and interpret results.
